...
<!-- Seller Sidebar -->
<div class="sidebar bg-gradient-to-br from-blue-500 via-blue-600 to-blue-800 text-white fixed top-0 left-0 w-64 h-screen overflow-y-auto z-40 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out" id="sidebar">
  ...
  <div class="p-4 border-b border-white border-opacity-20">
    <div class="flex items-center">
      ...
      " alt="Logo" class="w-12 h-12 mr-3 shadow-sm object-cover ">
      <div>
...
<!-- Seller Profile Card -->
    ...
    <div class="bg-white bg-opacity-10 backdrop-blur border-0 rounded-lg shadow-sm">
      <div class="p-3">
        <div class="flex items-start">
          <div class="w-10 h-10 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-3 shadow-sm flex-shrink-0">
            <i class="bi bi-person-fill text-white"></i>
          </div>
          <div class="flex-grow min-w-0">
            <h6 class="mb-0 font-bold text-white text-base truncate">
              <?php 
            ...
            <p class="text-white text-opacity-70 text-xs truncate mb-0 mt-0.5">
              <?php echo htmlspecialchars($_SESSION['email']); ?>
            </p>
            <?php endif; ?>
            <small class="text-white text-opacity-80 text-xs block mt-0.5">Seller</small>
          </div>
  ...
  <nav class="px-3">
    <ul class="space-y-1">
      ...
      <!-- Return/Refund -->
      <li>
        <a class="modern-nav-link flex items-center px-4 py-3 rounded-lg transition-all duration-200 hover:bg-white hover:bg-opacity-10 hover:transform hover:scale-105 relative overflow-hidden <?= ($currentPage == 'rr.php') ? 'bg-white bg-opacity-20 shadow-lg' : ''; ?>" 
           href="rr.php">
          <div class="w-5 h-5 flex items-center justify-center mr-3">
      ...
      <!-- Create Shop -->
      <li>
        <a class="modern-nav-link flex items-center px-4 py-3 rounded-lg transition-all duration-200 hover:bg-white hover:bg-opacity-10 hover:transform hover:scale-105 relative overflow-hidden <?= ($currentPage == 'shop_manage.php') ? 'bg-white bg-opacity-20 shadow-lg' : ''; ?>" 
           href="shop_manage.php">
          <div class="w-5 h-5 flex items-center justify-center mr-3">
            <i class="bi bi-shop"></i>
          </div>
          <span>Create Shop</span>
          <?php if ($currentPage == 'shop_manage.php'): ?>
            <div class="absolute right-2 w-1 h-6 bg-white rounded-full"></div>
          <?php endif; ?>
        </a>
      </li>
